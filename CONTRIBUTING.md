# Contributing to Phoenix Live Favicon
...
* [Support Request](https://elixirforum.com/tags/c/questions-help/53/phoenix_live_favicon)
* [Feature Request](https://elixirforum.com/t/feature-request-liveview-dynamic-favicon/48652)

We do our best to keep the issue tracker tidy and organized, making it useful
for everyone. For example, we classify open issues per perceived difficulty,
making it easier for developers to [contribute to Phoenix Live Favicon](#pull-requests).
...
Feature requests are welcome and should be discussed on [the Phoenix Live favicon topic on the Elixir forum](https://elixirforum.com/t/feature-request-liveview-dynamic-favicon/48652). But take a moment to find
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/phoenix_live_favicon
   # Navigate to the newly cloned directory
   cd phoenix
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/BartOtten/phoenix_live_favicon
   ```
